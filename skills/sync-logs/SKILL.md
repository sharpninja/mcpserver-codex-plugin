...
Use the Codex bridge path: `Invoke-CodexMcpPlugin.ps1 -Command Status`, `lib/plugin-hook.ps1 -HookName session-start`, `lib/repl-invoke.ps1`, and `lib/final-response.ps1`. Do not use raw REST for normal MCP mutations.
